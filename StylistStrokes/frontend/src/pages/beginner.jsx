      ...
      <div className="py-4 container container-fluid ">
        ...
        <div className="content text-muted bg-white rounded-4 p-4 shadow-sm">
          ...
          <p className="mt-3 fs-6">
            ...
            pens. It includes worksheets and video tutorials you can download
            and practice at your own pace.
          </p>
          <div className="mt-5">
            <h4 className="fw-semibold text-dark">In-depth Course Overview</h4>
            <p>
              The Beginner's Calligraphy course is structured to guide learners
              from the very basics of writing to building muscle memory for
              consistent strokes. You will explore letterforms in lowercase and
              uppercase, practice spacing and alignment, and develop a personal
              writing rhythm.
            </p>
            <p>
              In addition to hands-on exercises, the course includes
              downloadable practice sheets, guided video demonstrations, and
              weekly assignments to keep you motivated. You'll also gain insight
              into pen maintenance, ink types, and paper selection for different
              styles of calligraphy.
            </p>
            <p>
              By the end of the course, you will be able to confidently write
              beautiful letter compositions, understand common mistakes and how
              to fix them, and have a strong foundation to move on to
              intermediate and advanced calligraphy styles.
            </p>
          </div>
          <div className="student-testimonials mt-5">
            ...
            <div className="testimonial mt-4">
              <p className="italic">
                "This course helped me build a solid foundation in brush
                lettering. The video tutorials were very clear!"
              </p>
            ...
            <div className="testimonial mt-4">
              <p className="italic">
                "Loved the pace and structure. Great for absolute beginners like
                me. Highly recommended!"
              </p>
              <p className="fw-bold">- Michael T.</p>
            </div>
          </div>
          ...
          <div className="mt-5 text-center">
            <a
              href="/contact"
              className="btn btn-gradient-custom px-4 py-2 rounded-pill shadow-sm"
            >
              Enroll now !
            </a>
          </div>
