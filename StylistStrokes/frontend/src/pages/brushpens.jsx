      ...
      <div className="py-4 container">
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p>
              Beyond basic strokes, this course dives deeper into expressive
              calligraphy using brush pens. You’ll master advanced pressure
              techniques, explore creative layouts, and refine your unique
              style.
            </p>

            <h5 className="fw-semibold text-dark mt-4">
            ...
            />
            <p>
              This course is ideal for those who already have a foundation in
              calligraphy or have completed the beginner’s course. Whether
              you're a hobbyist or aspiring professional, this course will
              strengthen your control and creativity with brush pens.
            </p>
          ...
          <p>
            This course is perfect for intermediate calligraphers who want to
            enhance their brush pen skills. You’ll learn how to form beautiful
            brush pen scripts and explore artistic techniques to create unique
            letterforms and flourishing.
          </p>
          ...
          <div className="mt-4">
            <h4 className="fw-semibold text-dark">In-depth Course Overview</h4>
            <p>
              Beyond basic strokes, you will explore techniques for fluid
              composition, dynamic layouts, and personal artistic expression.
              Our carefully structured exercises help you master balance,
              spacing, and movement to bring your brush calligraphy to life.
            </p>
            <p>
              The course also introduces color transitions, advanced curves, and
              how to craft complete pieces like greeting cards, invitations, or
              artistic quotes that showcase your own style.
            </p>
          </div>
          <div className="student-testimonials mt-5">
            ...
            <div className="testimonial mt-4">
              <p className="italic">
                "I’ve taken a few calligraphy courses, but this one really
                unlocked my brush pen potential. The flourishes module was my
                favorite!"
              </p>
              <p className="fw-bold">- Chloe A., Art Student</p>
            </div>

            <div className="testimonial mt-4">
              <p className="italic">
                "The video demos and practice sheets made it easy to follow
                along. I loved seeing my lettering evolve each week!"
              </p>
