        ...
        <div className='d-flex row'>
            <div className="col-md-6 order-md-1">
                <h3 className="fs-2 mb-1 fw-semibold">
                    PAST IS A LEGACY, FUTURE IS A MASTERPIECE!
                </h3>
                <p className="mb-4">
                ...
                <div className="row mt-3 gy-3">
                    ...
                    <AboutNumber n='600+' text='Active crews of the world'></AboutNumber>
                </div>
                <div className="row mt-3 gy-3">
                    <AboutNumber n='1000+' text='Lessons for those who love'></AboutNumber>
                    <AboutNumber n='$20,000+' text='Money raised by enthusiast'></AboutNumber>
                </div>
